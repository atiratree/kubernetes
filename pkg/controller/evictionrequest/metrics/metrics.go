...
var (
	// ResponderState tracks the state of each responder per Eviction.
	// Combined with the Eviction creationTimestamp, this can help
	...
	ResponderState = metrics.NewGaugeVec(
		&metrics.GaugeOpts{
			...
			Help:           "The state of each responder for the Eviction.",
			StabilityLevel: metrics.ALPHA,
		},
		[]string{"namespace", "eviction", "target_name", "target_type", "responder", "state"},
	)
	...
	RequesterIntent = metrics.NewGaugeVec(
		&metrics.GaugeOpts{
			...
			Help:           "The intent and target of the EvictionRequest.",
			StabilityLevel: metrics.ALPHA,
		},
